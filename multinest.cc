...
int main(int argc, char *argv[])
{
	...
	minimize Chi2("../6waves_2014-09-05_10:08:53.191171.yaml");
	Chi2.initCouplings();
	...
	double Ztol = -1.E6;				// all the modes with logZ < Ztol are ignored
	...
	char root[100] = "chains/outoutout";		// root for output files
	...
	double logZero = -1.E10;			// points with loglike < logZero will be ignored by MultiNest
	
	int maxiter = 0;				// max no. of iterations, a non-positive value means infinity. MultiNest will terminate if either it 
							// has done max no. of iterations or convergence criterion (defined through tol) has been satisfied
	
	void *context = &Chi2;				// not required by MultiNest, any additional information user wants to pass
