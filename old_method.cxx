...
//#######################################################################################################################################################
double old_method::getParameter(			size_t 						i)						const{
...
//#######################################################################################################################################################
///Get parameters
const std::vector<double> old_method::parameters()													const{
...
void old_method::init_lower_limits(int n){
...
void old_method::init_upper_limits(int n){
...
std::vector<std::complex<double> > old_method::getUnbranchedCouplings(
							const std::vector<std::complex<double> >	&cpl,
...
void old_method::update_min_max_bin(){
...
bool old_method::loadParameterValues(
							YAML::Node					&waveset,
							YAML::Node					&param){
